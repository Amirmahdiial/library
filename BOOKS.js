      ...
      return `
        <div class="container">
            ...
            <div class="overlay">
                ...
                <button class="btn-like" onclick="addToFavorite(${book.id})">❤</button>
            </div>
      </div>
        `;
    })
...
function favkar(){
  ...
  document.getElementById("backButton").classList.add("unhidden")
}
document.getElementById("backButton").addEventListener("click", ()=>{
  document.querySelector(".filters").classList.remove("hidden");
  document.getElementById("backButton").classList.remove("unhidden")
})
renderBooks(BOOKS);
checkState();
